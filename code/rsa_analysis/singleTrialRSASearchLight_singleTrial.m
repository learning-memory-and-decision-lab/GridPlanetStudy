...
% load the concatenated single trial data, calculate distances
% between trial pairs and carry out regression using specified hypothesis
% RDMs in searchlight across whole brain
